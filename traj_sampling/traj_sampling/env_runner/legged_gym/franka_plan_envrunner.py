"""
FrankaPlanEnvRunner for Franka arm trajectory optimization experiments.

This module implements an environment runner specifically for Franka arm planning
...
- Enhanced data collection for noise scheduling experiments
"""
...
class FrankaPlanEnvRunner(LeggedGymEnvRunner2):
    """Environment runner for Franka arm planning experiments with enhanced tracking.
    ...
    2. Task completion detection and metrics
    3. Enhanced data collection for noise scheduling experiments
    """

    def __init__(self,
                 output_dir: str = "./output",
                 task_name: str = "franka_batch_rollout",
                 num_main_envs: int = 4,
                 ...
                 experiment_name: str = "franka_plan_experiment"):
        """Initialize the FrankaPlanEnvRunner.

        Args:
            experiment_name: Name of the experiment for data organization
            Other args: Same as LeggedGymEnvRunner2
        """
        # Set default trajectory config for Franka if not provided
        if trajectory_opt_config is None:
            trajectory_opt_config = FrankaTrajectoryOptCfg()
        ...
        # Enhanced tracking for Franka experiments
        ...
        print(f"FrankaPlanEnvRunner initialized for experiment: {experiment_name}")
    ...
    def run_with_trajectory_optimization(self, seed: int = 0, **kwargs) -> Dict[str, Any]:
        """Run with trajectory optimization and enhanced tracking."""
        ...
        print(f"Starting Franka planning experiment: {self.experiment_name}")
        ...
        try:
            for step in range(self.max_steps):
                ...
                # Enhanced tracking for Franka experiments
                self._track_episode_metrics(rewards, dones, step)
        ...
        print(f"\nFranka planning experiment completed: {self.experiment_name}")
        ...
        results = {
            ...
            # Enhanced Franka-specific metrics
    ...
    def run(self, policy=None, seed: int = 0, **kwargs) -> Dict[str, Any]:
        ...
        print(f"Starting Franka baseline experiment: {controller_type}")
